...
import logo from "../../assets/undraw_server-error_syuz.svg";

export default function FaildOrder() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-white px-6 md:px-12">
      <div className="text-center">
        ...
        <p className="text-base sm:text-lg mt-4 text-gray-500">
          Something went wrong with your order. Please try again later. If you
