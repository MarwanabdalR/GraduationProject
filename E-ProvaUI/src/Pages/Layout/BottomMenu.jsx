            ...
            <div className='flex flex-wrap mx-[-15]'>
                <div className='border-r border-[#e2e2e2] h-[55px] items-center justify-center flex basis-0 flex-grow max-w-full w-full px-[15px]'>
                    ...
                    >
                        ...
                        <span className='block font-semibold text-[10px] text-[#868686] capitalize mt-[2px] text-center'>Home</span>
                    </Link>
                </div>
                <div className='border-r border-[#e2e2e2] h-[55px] items-center justify-center flex basis-0 flex-grow max-w-full w-full px-[15px]'>
                    <Link 
                    ...
                    >
                        ...
                        <span className='block font-semibold text-[10px] text-[#868686] capitalize mt-[1px] text-center'>Shopping</span>
                    </Link>
                </div>
                <div className='border-r border-[#e2e2e2] h-[55px] items-center justify-center flex basis-0 flex-grow max-w-full w-full px-[15px]'>
                    <Link 
                    ...
                    >
                        ...
                        <span className='block font-semibold text-[10px] text-[#868686] capitalize mt-[2px] text-center'>Wishlist</span>
                        <div className='top-[-4px] text-[#fff] bg-[#181818]  border border-[#181818] w-[16px] h-[16px] min-w-[16px] text-[10px] z-[9px] flex items-center justify-center font-semibold text-center  absolute rounded-[50%] right-0 left-5'>{count}</div>
                    </Link>
                </div>
                <div className='border-r-[#e2e2e2] h-[55px] items-center justify-center flex basis-0 flex-grow max-w-full w-full px-[15px]'>
                    ...
                    >
                        ...
                        <span className='block font-semibold text-[10px] text-[#868686] capitalize mt-[1px] text-center'>Account</span>
                    </Link>
                </div>
            </div>
        </div>
